    ...
    <body>
        ...
        <%
            if(request.getParameter("btnedit")!=null){
                 String selu="select * from tbl_shop where shop_password='"+request.getParameter("txtcurntpassword")+"' and shop_id='"+session.getAttribute("shopid")+"'";
                ResultSet rsu=con.selectCommand(selu);
                System.out.println(selu);
            if(rsu.next())
            {
                String up="update tbl_shop set shop_password='"+request.getParameter("txtnewpassword")+"' where shop_id='"+session.getAttribute("shopid")+"'";
