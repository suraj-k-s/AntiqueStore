                    ...
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="Biddingproduct.jsp">Bidding Product</a>
                                </li>
                                <li>
                                    <a href="UserRequest.jsp">User Requets</a>
                                </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-sitemap fa-3x"></i>Registration<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="ManageDeliveryWorkers.jsp">Delivery Workers</a>
                                </li>
                            </ul>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Userbookings.jsp">User Booking</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <%--<li>
                                 <a  href="ActiveStatus.php"><i class="fa fa-desktop fa-3x"></i>Contractor Status</a>
                             </li>--%>
                    </ul>
