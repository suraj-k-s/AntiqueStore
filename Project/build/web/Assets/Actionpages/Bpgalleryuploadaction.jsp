<%-- 
    Document   : Bpgalleryuploadaction
    Created on : 18 Mar, 2022, 3:55:58 PM
    Author     : DELL
--%>
...
if(isMultipart)
{
   ...
   Iterator itr=items_list.iterator();
    ...
    while(itr.hasNext())
    {
       ...
       else
       {
         ...
         String ext=file_name.substring(file_name.lastIndexOf("."));
            ...
            image="Biddingproductphoto_"+r_num+ext;
    ...
    //Strinh str1="insert into tbl_wantedlist ()";
        ...
        String str1="insert into tbl_bpgallery(bproduct_id,bpgallery_image,bpgallery_caption)values('" + session.getAttribute("bpid")+ "','" + image +"','" + value[0] + "')";
   out.println(str1);
