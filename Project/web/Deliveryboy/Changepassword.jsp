<%-- 
    ...
    Created on : 24 Feb, 2022, 11:03:35 PM
    Author     : DELL
--%>
    ...
    <body>
        ...
        <%
            if(request.getParameter("btnedit")!=null){
                 String selu="select * from tbl_dboy where dboy_password='"+request.getParameter("txtcurntpassword")+"' and dboy_id='"+session.getAttribute("dboyid")+"'";
                ResultSet rsu=con.selectCommand(selu);
                System.out.println(selu);
            if(rsu.next())
            {
                String up="update tbl_dboy set dboy_password='"+request.getParameter("txtnewpassword")+"' where dboy_id='"+session.getAttribute("dboyid")+"'";
